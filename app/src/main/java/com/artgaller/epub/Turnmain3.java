...
import com.artgaller.reader.activity.DownloadManageActivity;
import com.artgaller.reader.utils.BookDBHelper;
import com.artgaller.reader.utils.MyTools;
...
//			String epub=DL.getPath() + "/"+bookurl;
			...
			else
			{
				...
				mMenuTop = new MenuTopActivity(this, (com.artgaller.epub.MenuTopActivity.OnMenuItemSelectedListener)this,getLayoutInflater());
				mMenuBottom = new MenuBottomActivity(this, (com.artgaller.epub.MenuBottomActivity.OnMenuItemSelectedListener)this, getLayoutInflater());
