package com.artgaller.reader.utils;
...
import com.artgaller.reader.activity.PublicClassContentActivity.UrlData;
import com.artgaller.reader.data.KeChengData;
import com.artgaller.reader.data.YaoYiYaoData;
import com.artgaller.reader.data.KeChengData.Data;
...
//		System.out.println(new String(data,"GB2312"));
	...
	public void parseXiaoxiList(InputStream inStream, List<com.artgaller.reader.data.XiaoXiData.Data> list) throws Exception {
		byte[] data = StreamTool.read(inStream);
		String json = new String(data,"GB2312");
		JSONObject jsonObject = new JSONObject(json);
		if (jsonObject.getString("status").equals("0")) {
			...
			for (int i = 0; i < datas.length(); i++) {
				...
				list.add(new com.artgaller.reader.data.XiaoXiData.Data(id, parentId, send, to, type, isread, title, dt));
			}
		}
	}
	...
	public void parseClassicBookList(InputStream inStream,
			List<com.artgaller.reader.data.ClassicBookListData.Data> iMG_DESCRIPTIONS) throws Exception {
		byte[] data = StreamTool.read(inStream);
		String json = new String(data);
		JSONObject jsonObject = new JSONObject(json);
		if (jsonObject.getString("status").equals("0")) {
			...
			for (int i = 0; i < jsonArray.length(); i++) {
				...
				if(i+1 == jsonArray.length()){
					...
					iMG_DESCRIPTIONS.add(new com.artgaller.reader.data.ClassicBookListData.Data(
	...
	public void parseNewBooksList(InputStream inStream,
			List<com.artgaller.reader.data.NewBooksListData.Data> iMG_DESCRIPTIONS) throws Exception {
		byte[] data = StreamTool.read(inStream);
		String json = new String(data);
		JSONObject jsonObject = new JSONObject(json);
		if (jsonObject.getString("status").equals("0")) {
			...
			for (int i = 0; i < jsonArray.length(); i++) {
				...
				if(i+1 == jsonArray.length()){
					...
					iMG_DESCRIPTIONS.add(new com.artgaller.reader.data.NewBooksListData.Data(
							title.get(0), imgurl.get(0), bookid.get(0), author.get(0),
							title.get(1), imgurl.get(1), bookid.get(1), author.get(1),
							title.get(2), imgurl.get(2), bookid.get(2), author.get(2),
							title.get(3), imgurl.get(3), bookid.get(3), author.get(3),
...
//		item.add(map);  
	...
	public void parsePublicClassList(InputStream inStream,
			List<com.artgaller.reader.data.PublicClassListData.Data> iMG_DESCRIPTIONS) throws Exception {
		byte[] data = StreamTool.read(inStream);
		String json = new String(data, "GB2312");
		JSONObject jsonObject = new JSONObject(json);
		if (jsonObject.getString("status").equals("0")) {
			...
			for (int i = 0; i < jsonArray.length(); i++) {
				...
				if(i+1 == jsonArray.length()){
					...
					iMG_DESCRIPTIONS.add(new com.artgaller.reader.data.PublicClassListData.Data(
	...
	public void parseHuoDongList(String response, List<com.artgaller.reader.data.HuoDongListData.Data> listdata) throws Exception{
		JSONObject object = new JSONObject(response);
		JSONArray jsonArray = object.getJSONArray("data");
		for (int i = 0; i < jsonArray.length(); i++) {
			JSONObject jsonObject = jsonArray.getJSONObject(i);
			listdata.add(new com.artgaller.reader.data.HuoDongListData.Data(jsonObject.getString("title"),
	...
	public void parseCommentList(String response, List<com.artgaller.reader.data.ActivityCommentData.Data> listdata) throws Exception{
...
//			JSONObject author = jsonObject.getJSONObject("userName");
			...
			listdata.add(new com.artgaller.reader.data.ActivityCommentData.Data(
	...
	public void parseZhiChangList(String response,
			List<com.artgaller.reader.data.ZhiChangListData.Data> list_Data) throws Exception {
		// TODO Auto-generated method stub
		JSONObject jsonObject = new JSONObject(response);
		JSONArray jsonArray = jsonObject.getJSONArray("data");
		for (int i = 0; i < jsonArray.length(); i++) {
			JSONObject data = jsonArray.getJSONObject(i);
			list_Data.add(new com.artgaller.reader.data.ZhiChangListData.Data(data.getString("position"),
