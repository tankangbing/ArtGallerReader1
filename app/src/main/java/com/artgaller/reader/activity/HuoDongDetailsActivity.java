...
import com.artgaller.reader.adapter.ActivityCommentAdapter;
import com.artgaller.reader.data.ActivityCommentData;
import com.artgaller.reader.utils.ParseJson;
import com.artgaller.reader.utils.PhotoUtil;
import com.artgaller.reader.views.BaseActivity;
import com.artgaller.reader.views.XListView;
import com.artgaller.reader.views.XListView.IXListViewListener;
		...
		for (int i = 0; i < myCommentImgViews.length; i++) {
			myCommentImgViews[i].setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					// } else {intent.addCategory(Intent.CATEGORY_OPENABLE);
